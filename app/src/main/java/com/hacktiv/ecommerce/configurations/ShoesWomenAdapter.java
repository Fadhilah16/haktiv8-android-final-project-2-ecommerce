...
public class
ShoesWomenAdapter extends RecyclerView.Adapter<ShoesWomenAdapter.ViewHolder> {

    List<String> title, image;
    Context context;


    public ShoesWomenAdapter(Context context, List<String> title, List<String> image) {
