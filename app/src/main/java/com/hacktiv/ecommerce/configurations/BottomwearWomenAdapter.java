...
public class
BottomwearWomenAdapter extends RecyclerView.Adapter<BottomwearWomenAdapter.ViewHolder> {

    List<String> title, image;
    Context context;


    public BottomwearWomenAdapter(Context context, List<String> title, List<String> image) {
