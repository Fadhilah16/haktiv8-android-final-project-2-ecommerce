...
public class
TshirtWomenAdapter extends RecyclerView.Adapter<TshirtWomenAdapter.ViewHolder> {

    List<String> title, image;
    Context context;


    public TshirtWomenAdapter(Context context, List<String> title, List<String> image) {
