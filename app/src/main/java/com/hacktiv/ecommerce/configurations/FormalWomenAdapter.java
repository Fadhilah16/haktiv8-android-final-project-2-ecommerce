...
public class
FormalWomenAdapter extends RecyclerView.Adapter<FormalWomenAdapter.ViewHolder> {

    List<String> title, image;
    Context context;


    public FormalWomenAdapter(Context context, List<String> title, List<String> image) {
